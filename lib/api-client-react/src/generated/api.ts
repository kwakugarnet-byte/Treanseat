 ...
 */
export const listBikes = async ( options?: Parameters<typeof customFetch>[1]): Promise<Bike[]> => {
 ...
 */
export const createBike = async (bikeInput: BikeInput, options?: Parameters<typeof customFetch>[1]): Promise<Bike> => {
 ...
 * @summary Get a bike
 */
export const getBike = async (id: number, options?: Parameters<typeof customFetch>[1]): Promise<Bike> => {
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetBikeQueryKey(id);
   ...
   return  { queryKey, queryFn, enabled: id !== null && id !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getBike>>, TError, TData> & { queryKey: QueryKey }
}
...
export const updateBike = async (id: number,
    bikeUpdate: BikeUpdate, options?: Parameters<typeof customFetch>[1]): Promise<Bike> => {
  ...
  return customFetch<Bike>(getUpdateBikeUrl(id),
  {
    ...
    method: 'PATCH',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
    body: JSON.stringify(bikeUpdate)
  }
);}
 ...
 */
export const deleteBike = async (id: number, options?: Parameters<typeof customFetch>[1]): Promise<SuccessResponse> => {
 ...
 */
export const listMaintenance = async (params?: ListMaintenanceParams, options?: Parameters<typeof customFetch>[1]): Promise<MaintenanceRecord[]> => {
 ...
 */
export const createMaintenance = async (maintenanceInput: MaintenanceInput, options?: Parameters<typeof customFetch>[1]): Promise<MaintenanceRecord> => {
 ...
 */
export const listMaintenanceTypes = async ( options?: Parameters<typeof customFetch>[1]): Promise<MaintenanceType[]> => {
 ...
 */
export const createMaintenanceType = async (maintenanceTypeInput: MaintenanceTypeInput, options?: Parameters<typeof customFetch>[1]): Promise<MaintenanceType> => {
  ...
  return customFetch<MaintenanceType>(getCreateMaintenanceTypeUrl(),
  {
    ...
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
    body: JSON.stringify(maintenanceTypeInput)
  }
);}
...
export const updateMaintenanceType = async (id: number,
    maintenanceTypeUpdate: MaintenanceTypeUpdate, options?: Parameters<typeof customFetch>[1]): Promise<MaintenanceType> => {
  ...
  return customFetch<MaintenanceType>(getUpdateMaintenanceTypeUrl(id),
  {
    ...
    method: 'PATCH',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
    body: JSON.stringify(maintenanceTypeUpdate)
  }
);}
 ...
 */
export const deleteMaintenanceType = async (id: number, options?: Parameters<typeof customFetch>[1]): Promise<SuccessResponse> => {
...
export const updateMaintenance = async (id: number,
    maintenanceUpdate: MaintenanceUpdate, options?: Parameters<typeof customFetch>[1]): Promise<MaintenanceRecord> => {
 ...
 */
export const deleteMaintenance = async (id: number, options?: Parameters<typeof customFetch>[1]): Promise<SuccessResponse> => {
 ...
 */
export const getProfitSummary = async (params?: GetProfitSummaryParams, options?: Parameters<typeof customFetch>[1]): Promise<ProfitSummary> => {
 ...
 */
export const getCombinedProfit = async (params?: GetCombinedProfitParams, options?: Parameters<typeof customFetch>[1]): Promise<CombinedProfit> => {
 ...
 */
export const listSnookerBoards = async ( options?: Parameters<typeof customFetch>[1]): Promise<SnookerBoard[]> => {
 ...
 */
export const createSnookerBoard = async (snookerBoardInput: SnookerBoardInput, options?: Parameters<typeof customFetch>[1]): Promise<SnookerBoard> => {
  ...
  return customFetch<SnookerBoard>(getCreateSnookerBoardUrl(),
  {
    ...
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
    body: JSON.stringify(snookerBoardInput)
  }
);}
 ...
 */
export const listSnookerSessions = async (params?: ListSnookerSessionsParams, options?: Parameters<typeof customFetch>[1]): Promise<SnookerSession[]> => {
 ...
 */
export const createSnookerSession = async (snookerSessionInput: SnookerSessionInput, options?: Parameters<typeof customFetch>[1]): Promise<SnookerSession> => {
  ...
  return customFetch<SnookerSession>(getCreateSnookerSessionUrl(),
  {
    ...
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
    body: JSON.stringify(snookerSessionInput)
  }
);}
...
export const updateSnookerSession = async (id: number,
    snookerSessionUpdate: SnookerSessionUpdate, options?: Parameters<typeof customFetch>[1]): Promise<SnookerSession> => {
  ...
  return customFetch<SnookerSession>(getUpdateSnookerSessionUrl(id),
  {
    ...
    method: 'PATCH',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
    body: JSON.stringify(snookerSessionUpdate)
  }
);}
 ...
 */
export const deleteSnookerSession = async (id: number, options?: Parameters<typeof customFetch>[1]): Promise<SuccessResponse> => {
 ...
 */
export const listSnookerMaintenance = async ( options?: Parameters<typeof customFetch>[1]): Promise<SnookerMaintenanceRecord[]> => {
 ...
 */
export const createSnookerMaintenance = async (snookerMaintenanceInput: SnookerMaintenanceInput, options?: Parameters<typeof customFetch>[1]): Promise<SnookerMaintenanceRecord> => {
  ...
  return customFetch<SnookerMaintenanceRecord>(getCreateSnookerMaintenanceUrl(),
  {
    ...
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
    body: JSON.stringify(snookerMaintenanceInput)
  }
);}
...
export const updateSnookerMaintenance = async (id: number,
    snookerMaintenanceInput: SnookerMaintenanceInput, options?: Parameters<typeof customFetch>[1]): Promise<SnookerMaintenanceRecord> => {
 ...
 */
export const deleteSnookerMaintenance = async (id: number, options?: Parameters<typeof customFetch>[1]): Promise<SuccessResponse> => {
 ...
 */
export const listSnookerWorkers = async ( options?: Parameters<typeof customFetch>[1]): Promise<SnookerWorker[]> => {
 ...
 */
export const createSnookerWorker = async (snookerWorkerInput: SnookerWorkerInput, options?: Parameters<typeof customFetch>[1]): Promise<SnookerWorker> => {
  ...
  return customFetch<SnookerWorker>(getCreateSnookerWorkerUrl(),
  {
    ...
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
    body: JSON.stringify(snookerWorkerInput)
  }
);}
...
export const updateSnookerWorker = async (id: number,
    snookerWorkerInput: SnookerWorkerInput, options?: Parameters<typeof customFetch>[1]): Promise<SnookerWorker> => {
 ...
 */
export const deleteSnookerWorker = async (id: number, options?: Parameters<typeof customFetch>[1]): Promise<SuccessResponse> => {
 ...
 */
export const getSnookerSalary = async (params: GetSnookerSalaryParams, options?: Parameters<typeof customFetch>[1]): Promise<SnookerSalarySummary> => {
 ...
 */
export const getSnookerSummary = async ( options?: Parameters<typeof customFetch>[1]): Promise<SnookerSummary> => {
 ...
 */
export const getBikePerformance = async ( options?: Parameters<typeof customFetch>[1]): Promise<BikePerformance[]> => {
 ...
 */
export const createRider = async (riderInput: RiderInput, options?: Parameters<typeof customFetch>[1]): Promise<Rider> => {
 ...
 */
export const getRider = async (id: number, options?: Parameters<typeof customFetch>[1]): Promise<Rider> => {
...
export const updateRider = async (id: number,
    riderUpdate: RiderUpdate, options?: Parameters<typeof customFetch>[1]): Promise<Rider> => {
 ...
 */
export const deleteRider = async (id: number, options?: Parameters<typeof customFetch>[1]): Promise<SuccessResponse> => {
